...
import org.team11.tickebook.theatreservice.clients.fallback.AdminClientFallback;
...
@FeignClient(name = "ADMIN-SERVICE", configuration = FeignConfig.class, fallback = AdminClientFallback.class)
