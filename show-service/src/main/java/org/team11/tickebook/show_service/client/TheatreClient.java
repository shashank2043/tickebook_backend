...
import org.team11.tickebook.show_service.client.fallback.TheatreClientFallback;
import org.team11.tickebook.show_service.dto.SeatDto;

import java.util.List;
import java.util.UUID;

@FeignClient(name = "THEATRE-SERVICE", configuration = FeignConfig.class, fallback = TheatreClientFallback.class)
